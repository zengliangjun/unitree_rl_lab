...
from isaaclab_ext.assets.actuators import actuator_delay
...
LYENBOT_CFG = unitree.UnitreeArticulationCfg(
    ...
    actuators={
        "N7520-14.3": actuator_delay.ImplicitDelayActuatorCfg(
        ...
        "N7520-22.5": actuator_delay.ImplicitDelayActuatorCfg(
        ...
        "N5020-16-parallel": actuator_delay.ImplicitDelayActuatorCfg(
