...
class RewardsCfg:
    ...
    joint_vel = RewTerm(func=mdp.joint_vel_l2, weight=-0.003) # weight=-0.001)
    joint_acc = RewTerm(func=mdp.joint_acc_l2, weight=-7.5e-7) # weight=-2.5e-7)
    action_rate = RewTerm(func=mdp.action_rate_l2, weight=-0.05)
    ankle_action_rate = RewTerm(func=mdp.action_rate_l2_ext,
                          weight=-0.03,
...
class CurriculumCfg:
    ...
    stand_levels = CurrTerm(mdp.reward_weight_levels,
                    params={
    ...
    '''
    ang_levels = CurrTerm(mdp.reward_weight_levels,
                    params={
                        "reward_term_name": "track_ang_vel_z",
                        "min_weight": 4,
                        "max_weight": 1.2,
                        "upper_threshold_length": 0.8,
                        "lower_threshold_length": 0.3,
                        "degree": - 1e-5}
    )
    '''
