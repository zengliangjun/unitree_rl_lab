...
from unitree_rl_lab.tasks.loco_upper.mdp import actions_cfg
...
class ActionsCfg:
    ...
    MotionPositionAction = actions_cfg.MotionsActionCfg(
        asset_name="robot",
        joint_names=[
            "waist_yaw_joint",
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        leg_action = ObsTerm(func=mdp.last_action, params={"action_name": "JointPositionAction"})
        upper_action = ObsTerm(func=mdp.last_action, scale=0.25, params={"action_name": "MotionPositionAction"})
