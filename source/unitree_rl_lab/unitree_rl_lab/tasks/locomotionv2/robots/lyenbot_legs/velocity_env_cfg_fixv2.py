...
class RewardsCfg:
    ...
    track_ang_vel_z = RewTerm(
        func=rewards.track_ang_vel_z_world_exp, weight=1.85, params={"command_name": "base_velocity", "std": math.sqrt(0.25)}
    )
    ...
    # -- robot
    flat_x = RewTerm(func=rewards_ext.flat_orientation_x, weight=-9.0)
    flat_y = RewTerm(func=rewards_ext.flat_orientation_y, weight=-2.5)
